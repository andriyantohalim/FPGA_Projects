...
HD_PWD='D:/FPGA_Projects/arithmetic_operations_1/arithmetic_operations_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arithmetic_op_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arithmetic_op_tb.tcl
