...
HD_PWD='D:/FPGA_Projects/Simple_PWM_Module/Simple_PWM_Module.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PWM_Module_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PWM_Module_tb.tcl
