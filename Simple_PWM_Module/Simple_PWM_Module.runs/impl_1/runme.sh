...
HD_PWD='D:/FPGA_Projects/Simple_PWM_Module/Simple_PWM_Module.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PWM_Module_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PWM_Module_tb.tcl -notrace
